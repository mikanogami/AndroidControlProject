...
{
    public delegate void OnGestureCallback(Vector2 startPos, Vector2 endPos, float duration, bool willContinue);
    ...
    void SendGestureMsg(bool isContinuing)
    {
